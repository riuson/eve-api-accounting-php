...
<head>
	<title>Обновление стендингов всех мастер-аккаунтов</title>
...
<body class='b-page'>
	<?php
		...
		while($rowUser = $qr->fetch_assoc())
		{
			...
			$msg .= "Updating standings of $rowUser[login]...<br>";
			$str =  "Updating standings of $rowUser[login]:<br>";
