...
<head>
	<title>Обновление killlog всех мастер-аккаунтов</title>
...
<body class='b-page'>
	<?php
		...
		while($rowUser = $qr->fetch_assoc())
		{
			...
			$msg .= "Updating kills of $rowUser[login]...<br>";
			$str =  "Updating kills of $rowUser[login]:<br>";
