...
<head>
	<title>Обновление member security всех мастер-аккаунтов</title>
...
<body class='b-page'>
	<?php
		...
		while($rowUser = $qr->fetch_assoc())
		{
			...
			$msg .= "Updating member security of $rowUser[login]...<br>";
			$str =  "Updating member security of $rowUser[login]:<br>";
			...
			$apires = $api->UpdateMemberSecurity();
			$msg .= $apires["message"];
			$str .= $apires["message"];
			$msg .= "<br>";
