...
<head>
	<title>Обновление market orders всех мастер-аккаунтов</title>
...
<body class='b-page'>
	<?php
		...
		while($rowUser = $qr->fetch_assoc())
		{
			...
			$msg .= "Updating market orders of $rowUser[login]...<br>";
			$str =  "Updating market orders of $rowUser[login]:<br>";
